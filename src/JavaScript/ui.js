 ...
 * ```
 */
async function delayPrint(eleOrSel, text, interval, add = false) {
    var _a, _b, _c;
    ...
    if (add)
        ...
        writeContent = text;
    let writeCount = (_c = (_b = element.textContent) === null || _b === void 0 ? void 0 : _b.length) !== null && _c !== void 0 ? _c : 0;
